...
const Mid = () => {
  return (
    <section>  <img className=' absolute  max-md:hidden  h-lvh  -z-0 ' src=".\img\Ellipse 1328.png" alt="" />  
    <div className=' bg-background mt-28  flex flex-col  justify-between container   '>
      ...
      <div className='    ' >
       <div className='mt-6   '>
              ...
              <div className='mt-10 '>
                ...
                <p className='pt-4 text-p ' >Stacks is a production-ready library of stackable content blocks built in React Native</p>
                <button className=' max-md:hidden mt-4 flex justify-center  bg-scenery w-44 rounded-3xl text-background  gap-5 text-center px-2 items-center  hover:bg-primary hover:text-black   h-12'>Download CV👉</button>
              </div>
         </div>
      </div>
